...
const HomeFilters = ({ setNftList, nftQuantity }) => {
  ...
  return (
    <Styled.Wrapper>
      <Styled.Container>
        <Styled.BurstIcon />
        <Styled.Text>{`${nftQuantity} available`}</Styled.Text>
      </Styled.Container>
...
HomeFilters.propTypes = {
  ...
  setNftList: PropTypes.func.isRequired
};

export default React.memo(HomeFilters);
