...
import { SellNftModal, TransferNftModal, CancelListingModal } from '~/components';
...
const NFTCard = () => {
  ...
  return (
    <>
      <CustomCard>
        <CustomCardHeader
          avatar={<Avatar alt="ss" src={dogImage} sx={{ width: 28, height: 28 }} />}
          title="Disney"
        />
        <CardMedia
